...
2	Blockly	Interactive Web app for developing python flow logic	50
3	Barbie	Turn student into dollsize human	1000
4	Rainbow	Build Brighticorn a house	500
5	Coal	Give coal for Christmas again	34
\.
...
COPY students (first_name, last_name, github, id) FROM stdin;
Jane	Hacker	jhacks	1
Sarah	Developer	sdevelops	2
\.
